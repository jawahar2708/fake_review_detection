...
log_reg_bundle = joblib.load("models/model_logreg.joblib")
rf_bundle = joblib.load("models/model_rf.joblib")
nb_bundle = joblib.load("models/model_nb.joblib")
svm_bundle = joblib.load("models/model_svm.joblib")

# XGBoost model + its TF-IDF and numeric feature info
xgb_tfidf = joblib.load("models/tfidf_xgb.joblib")

xgb_model = XGBClassifier()
xgb_model.load_model("models/model_xgb.json")

with open("models/xgb_numeric_cols.json") as f:
